...
export default [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'CrmAllocation/:id', name: 'Crm Allocation', component: () => import('@/view/CrmAllocation.vue') },
      ...
      { path: 'CrmContact/:id', name: 'crm_Contact', component: () => import('@/view/CrmContact.vue') }
    ]
  },
